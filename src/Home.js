                        ...
                        <div className="row gy-4 justify-content-center">
                            <div className="col-xl-3 col-lg-4 col-md-6">
                                <div className="gallery-item h-100">
                                    <img src="assets/img/gallery/gallery-1.jpg" className="img-fluid" alt=""></img>
                            ...
                            <div className="col-xl-3 col-lg-4 col-md-6">
                                <div className="gallery-item h-100">
                                    <img src="assets/img/gallery/gallery-2.jpg" className="img-fluid" alt=""></img>
                                    <div className="gallery-links d-flex align-items-center justify-content-center">
                            ...
                            <div className="col-xl-3 col-lg-4 col-md-6">
                                <div className="gallery-item h-100">
                                    <img src="assets/img/gallery/gallery-3.jpg" className="img-fluid" alt=""></img>
                                    <div className="gallery-links d-flex align-items-center justify-content-center">
                            ...
                            <div className="col-xl-3 col-lg-4 col-md-6">
                                <div className="gallery-item h-100">
                                    <img src="assets/img/gallery/gallery-4.jpg" className="img-fluid" alt=""></img>
                                    <div className="gallery-links d-flex align-items-center justify-content-center">
                            ...
                            <div className="col-xl-3 col-lg-4 col-md-6">
                                <div className="gallery-item h-100">
                                    <img src="assets/img/gallery/ck-1.jpg" className="img-fluid" alt=""></img>
                                    <div className="gallery-links d-flex align-items-center justify-content-center">
                            ...
                            <div className="col-xl-3 col-lg-4 col-md-6">
                                <div className="gallery-item h-100">
                                    <img src="assets/img/gallery/ck-2.jpg" className="img-fluid" alt=""></img>
                                    <div className="gallery-links d-flex align-items-center justify-content-center">
                            ...
                            <div className="col-xl-3 col-lg-4 col-md-6">
                                <div className="gallery-item h-100">
                                    <img src="assets/img/gallery/ck-3.jpg" className="img-fluid" alt=""></img>
                                    <div className="gallery-links d-flex align-items-center justify-content-center">
                            ...
                            <div className="col-xl-3 col-lg-4 col-md-6">
                                <div className="gallery-item h-100">
                                    <img src="assets/img/gallery/ck-4.jpg" className="img-fluid" alt=""></img>
                                    <div className="gallery-links d-flex align-items-center justify-content-center">
                            ...
                            <div className="col-xl-3 col-lg-4 col-md-6">
                                <div className="gallery-item h-100">
                                    <img src="assets/img/gallery/gallery-9.jpg" className="img-fluid" alt=""></img>
                                    <div className="gallery-links d-flex align-items-center justify-content-center">
                            ...
                            <div className="col-xl-3 col-lg-4 col-md-6">
                                <div className="gallery-item h-100">
                                    <img src="assets/img/gallery/gallery-10.jpg" className="img-fluid" alt=""></img>
                                    <div className="gallery-links d-flex align-items-center justify-content-center">
                            ...
                            <div className="col-xl-3 col-lg-4 col-md-6">
                                <div className="gallery-item h-100">
                                    <img src="assets/img/gallery/gallery-11.jpg" className="img-fluid" width="500" height="600" alt=""></img>
                                    <div className="gallery-links d-flex align-items-center justify-content-center">
                            ...
                            <div className="col-xl-3 col-lg-4 col-md-6">
                                <div className="gallery-item h-100">
                                    <img src="assets/img/gallery/gallery-12.jpg" className="img-fluid" alt=""></img>
                                    <div className="gallery-links d-flex align-items-center justify-content-center">
                            ...
                            <div className="col-xl-3 col-lg-4 col-md-6">
                                <div className="gallery-item h-100">
                                    <img src="assets/img/gallery/gallery-13.jpg" className="img-fluid" alt=""></img>
                                    <div className="gallery-links d-flex align-items-center justify-content-center">
                            ...
                            <div className="col-xl-3 col-lg-4 col-md-6">
                                <div className="gallery-item h-100">
                                    <img src="assets/img/gallery/gallery-14.jpg" className="img-fluid" alt=""></img>
                                    <div className="gallery-links d-flex align-items-center justify-content-center">
                            ...
                            <div className="col-xl-3 col-lg-4 col-md-6">
                                <div className="gallery-item h-100">
                                    <img src="assets/img/gallery/gallery-15.jpg" className="img-fluid" alt=""></img>
                                    <div className="gallery-links d-flex align-items-center justify-content-center">
                            ...
                            <div className="col-xl-3 col-lg-4 col-md-6">
                                <div className="gallery-item h-100">
                                    <img src="assets/img/gallery/gallery-16.jpg" className="img-fluid" alt=""></img>
                                    <div className="gallery-links d-flex align-items-center justify-content-center">
